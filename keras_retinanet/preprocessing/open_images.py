...
class OpenImagesGenerator(Generator):
    def __init__(
        ...
        # modified
        if subset == 'train':
            self.base_dir = os.path.join(main_dir, 'test01/test/test_kaggle')
        elif subset == 'validation':
            self.base_dir = os.path.join(main_dir, 'validation/validation/validation')
        ...
        # modified
        print('annotation_cache_json ', annotation_cache_json)
        # modified
